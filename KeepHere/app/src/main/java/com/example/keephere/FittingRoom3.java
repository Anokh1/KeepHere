...
public class FittingRoom3 extends AppCompatActivity {
    ...
    private static final String KEY_ITEM13 = "itemNumber1";
    private static final String KEY_ITEM14 = "itemNumber2";
    private static final String KEY_ITEM15 = "itemNumber3";
    private static final String KEY_ITEM16 = "itemNumber4";
    private static final String KEY_ITEM17 = "itemNumber5";
    private static final String KEY_ITEM18 = "itemNumber6";

    // Creating a variable for the object class
    KeepHere3 fittingRoom3;
    Report report;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fitting_room_3);
        ...
        databaseReference = firebaseDatabase.getReference("KeepHere3");

        sharedPreferences = getSharedPreferences(SHARED_PREF_NAME3, MODE_PRIVATE);

        String itemNum1 = sharedPreferences.getString(KEY_ITEM13, "NA");
        item1Barcode.setText(itemNum1);

        String itemNum2 = sharedPreferences.getString(KEY_ITEM14, "NA");
        item2Barcode.setText(itemNum2);

        String itemNum3 = sharedPreferences.getString(KEY_ITEM15, "NA");
        item3Barcode.setText(itemNum3);

        String itemNum4 = sharedPreferences.getString(KEY_ITEM16, "NA");
        item4Barcode.setText(itemNum4);

        String itemNum5 = sharedPreferences.getString(KEY_ITEM17, "NA");
        item5Barcode.setText(itemNum5);

        String itemNum6 = sharedPreferences.getString(KEY_ITEM18, "NA");
        item6Barcode.setText(itemNum6);


        fittingRoom3 = new KeepHere3();
...
// 123456
    ...
    ActivityResultLauncher<ScanOptions> barLauncher = registerForActivityResult(new ScanContract(), result -> {
        if(result.getContents() != null){
            AlertDialog.Builder builder = new AlertDialog.Builder(FittingRoom3.this); // alert box
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    DatabaseReference barcodeReference = FirebaseDatabase.getInstance().getReference("KeepHere3");
                    ...
                    checkBarcode.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.exists()){
                                // Toast message
                                Toast.makeText(FittingRoom3.this, "Item exists", Toast.LENGTH_SHORT).show();

                            } else {
                                String currentItemNumber = fittingRoom3.getItemNumber();
                                ...
                                if(!Objects.equals(currentItemNumber, barcodeNumber)){
                                    if(Objects.equals(currentItemNumber, "Item 1")){
                                        ...
                                        editor13.putString(KEY_ITEM13, barcodeNumber);
                                        editor13.apply();
                                    }
                                    if(Objects.equals(currentItemNumber, "Item 2")){
                                        ...
                                        editor14.putString(KEY_ITEM14, barcodeNumber);
                                        editor14.apply();
                                    }
                                    if(Objects.equals(currentItemNumber, "Item 3")){
                                        ...
                                        editor15.putString(KEY_ITEM15, barcodeNumber);
                                        editor15.apply();
                                    }
                                    if(Objects.equals(currentItemNumber, "Item 4")){
                                        ...
                                        editor16.putString(KEY_ITEM16, barcodeNumber);
                                        editor16.apply();
                                    }
                                    if(Objects.equals(currentItemNumber, "Item 5")){
                                        ...
                                        editor17.putString(KEY_ITEM17, barcodeNumber);
                                        editor17.apply();
                                    }
                                    if(Objects.equals(currentItemNumber, "Item 6")){
                                        ...
                                        editor18.putString(KEY_ITEM18, barcodeNumber);
                                        editor18.apply();
                                    }
                                }

                                databaseReference.push().setValue(fittingRoom3); // only save data in Firebase if user respond

                                // Toast message
                                Toast.makeText(FittingRoom3.this, "Item saved", Toast.LENGTH_SHORT).show();
    ...
    private void openScanner(String fittingRoomNumber, String itemNumber, String date){
        ...
        fittingRoom3.setFittingRoomNumber(fittingRoomNumber);  // to store fitting room number
        fittingRoom3.setItemNumber(itemNumber);                // to store item number
        fittingRoom3.setDate(date);

        FirebaseUser user = mAuth.getInstance().getCurrentUser();
        fittingRoom3.setUserEmail(user.getEmail());
    }

    private void storeBarcode(String barcodeNumber){
        fittingRoom3.setBarcodeNumber(barcodeNumber);           // to store barcode number
    }
        ...
        if(result.getContents() != null){
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    Query checkoutBarcode = barcodeReference.child("KeepHere3").orderByChild("barcodeNumber").equalTo(barcodeNumber);
                            ...
                            if(snapshot.exists()){
                                ...
                                for (DataSnapshot itemNumberSnapshot : snapshot.getChildren()){
                                    ...
                                    if(Objects.equals(currentItemNumber, "Item 1")){
                                        ...
                                        Toast.makeText(FittingRoom3.this, currentItemNumber, Toast.LENGTH_SHORT).show();
                                    }
                                    if(Objects.equals(currentItemNumber, "Item 2")){
                                        item2Barcode.setText("NA");
                                        SharedPreferences.Editor editor14 = sharedPreferences.edit();
                                        editor14.putString(KEY_ITEM14, "NA");
                                        editor14.apply();
                                    ...
                                    if(Objects.equals(currentItemNumber, "Item 3")){
                                        ...
                                        SharedPreferences.Editor editor15 = sharedPreferences.edit();
                                        editor15.putString(KEY_ITEM15, "NA");
                                        editor15.apply();
                                    ...
                                    if(Objects.equals(currentItemNumber, "Item 4")){
                                        ...
                                        SharedPreferences.Editor editor16 = sharedPreferences.edit();
                                        editor16.putString(KEY_ITEM16, "NA");
                                        editor16.apply();
                                    ...
                                    if(Objects.equals(currentItemNumber, "Item 5")){
                                        ...
                                        SharedPreferences.Editor editor17 = sharedPreferences.edit();
                                        editor17.putString(KEY_ITEM17, "NA");
                                        editor17.apply();
                                    ...
                                    if(Objects.equals(currentItemNumber, "Item 6")){
                                        ...
                                        SharedPreferences.Editor editor18 = sharedPreferences.edit();
                                        editor18.putString(KEY_ITEM18, "NA");
                                        editor18.apply();
                                ...
                                Toast.makeText(FittingRoom3.this, "Suspected stolen items", Toast.LENGTH_SHORT).show();
    ...
    public void clearFittingRoom(){
        DatabaseReference fittingRoom = FirebaseDatabase.getInstance().getReference("KeepHere3");
        ...
        editor13.putString(KEY_ITEM15, "NA");
        editor13.putString(KEY_ITEM16, "NA");
        editor13.putString(KEY_ITEM17, "NA");
